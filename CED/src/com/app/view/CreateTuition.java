 ...
 */
public class CreateTuition extends javax.swing.JFrame {
    ...
    public CreateTuition() {
        initComponents();
        tc.populateStudentComboBox(enrollmentcbb1);
        tc.populateAYTermComboBox(enrollmentcbb3);
    ...
    private void initComponents() {
        ...
        panel.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 70, 90, 10));
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        Tuition tuitionvar = new Tuition();

        try {
            int res = JOptionPane.showConfirmDialog(this, "Are you sure you want create record for Tuition?", "Confirm", JOptionPane.YES_NO_OPTION);
            if (res == JOptionPane.YES_OPTION) {
                ...
                tuitionvar.setStudentID(selectedStudent);
                tuitionvar.setAYTerm(selectedAYTerm);
                
                tc.addTuition(tuitionvar);                
                JOptionPane.showMessageDialog(null, "Record for Tuition successfully created!");
                int result = JOptionPane.showConfirmDialog(this, "Do you want to create another record for Tuition?", "Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateTuition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateTuition().setVisible(true);
            }
        });
    }
