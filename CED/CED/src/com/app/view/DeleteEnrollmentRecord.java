 ...
 */
public class DeleteEnrollmentRecord extends javax.swing.JFrame {

    /**
     * Creates new form DeleteEnrollmentRecord
     */
    EnrollmentController ec = new EnrollmentController();

    public DeleteEnrollmentRecord() {
        initComponents();
        ec.populateEnrollmentComboBox(deletecbb);
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Delete Enrollment Record");
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 460, 30, 50));
        ...
        jPanel6.add(gobackdeletemenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 0, 300, 50));
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        try {
            int res = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete record for Enrollment", "Confirm", JOptionPane.YES_NO_OPTION);
            if (res == JOptionPane.YES_OPTION) {
                
                String selectedEnrollmentStr = (String) deletecbb.getSelectedItem();
                int selectedEnrollment = Integer.parseInt(selectedEnrollmentStr);
                
                enrollmentvar.setEnrollmentID(selectedEnrollment);
                
                ec.deleteEnrollment(enrollmentvar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteEnrollmentRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteEnrollmentRecord().setVisible(true);
            }
        });
    }
