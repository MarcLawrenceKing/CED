...
public class UpdateScheduleRecord extends javax.swing.JFrame {
    ...
    public UpdateScheduleRecord() {
        initComponents();
        sc.populateScheduleComboBox(updatecbb1);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1260, 100));
        ...
        jPanel6.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 10, 30, 50));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 0, 30, 50));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if (res == JOptionPane.YES_OPTION) {
                ...
                if (!scheduleArea.getText().equals("")) {
                    String selectedScheduleStr = (String) updatecbb1.getSelectedItem();
                    int selectedSchedule = Integer.parseInt(selectedScheduleStr);

                    schedulevar.setScheduleID(selectedSchedule);
                    schedulevar.setSchedule(scheduleArea.getText());
                    
                    sc.updateSchedule(schedulevar);
