...
public class CreateSchedule extends javax.swing.JFrame {
    ...
    public CreateSchedule() {
        initComponents();
        sc.populateSubjectCodeComboBox(schedulecbb1);
        sc.populateSectionCodeComboBox(schedulecbb2);
        sc.populateAYTermComboBox(schedulecbb3);
        schedulecbb1.setSelectedIndex(-1);
        schedulecbb2.setSelectedIndex(-1);
        schedulecbb3.setSelectedIndex(-1);
    }
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        try {
            ...
            if (res == JOptionPane.YES_OPTION) {
                if (!scheduleArea1.getText().equals("")) {
                    String selectedSubject = (String) schedulecbb1.getSelectedItem();
                    String selectedSection = (String) schedulecbb2.getSelectedItem();
                    String selectedAYTerm = (String) schedulecbb3.getSelectedItem();

                    schedulevar.setSubjectCode(selectedSubject);
                    schedulevar.setSectionCode(selectedSection);
                    schedulevar.setAYTerm(selectedAYTerm);
                    schedulevar.setSchedule(scheduleArea1.getText());

                    sc.addSchedule(schedulevar);
