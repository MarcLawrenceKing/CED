...
public class CreateStudent extends javax.swing.JFrame {
    ...
    public CreateStudent() {
        initComponents();
        sc.populateAYTermComboBox(studentcbb1);
        sc.populateScholarshipComboBox(studentcbb2);
        sc.populateProgramComboBox(studentcbb3);
        studentcbb1.setSelectedIndex(-1);
        studentcbb2.setSelectedIndex(-1);
        studentcbb3.setSelectedIndex(-1);
    }
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        try {
            ...
            if (res == JOptionPane.YES_OPTION) {
                if (!createStudentField.getText().equals("")
                        || !createStudentField1.getText().equals("")
                        || !createStudentField2.getText().equals("")
                        || !createStudentField3.getText().equals("")
                        || !createStudentField4.getText().equals("")
                        || !createStudentField5.getText().equals("")) {
                    String selectedAYTerm = (String) studentcbb1.getSelectedItem();
                    String selectedScholarship = (String) studentcbb2.getSelectedItem();
                    String selectedProgram = (String) studentcbb3.getSelectedItem();

                    studentvar.setStudentName(createStudentField.getText());
                    ...
                    studentvar.setContactNumber(createStudentField1.getText());
                    studentvar.setAddress(createStudentField2.getText());
                    studentvar.setYearLevel(createStudentField3.getText());
                    studentvar.setSection(createStudentField4.getText());
                    studentvar.setCampus(createStudentField5.getText());

                    sc.addStudent(studentvar);
