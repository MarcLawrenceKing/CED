...
public class CreateTuitionFees extends javax.swing.JFrame {
    ...
    public CreateTuitionFees() {
        initComponents();
        tfc.populateTuitionComboBox(enrollmentcbb1);
        tfc.populateFeeComboBox(enrollmentcbb3);
    ...
    private void initComponents() {
        ...
        jPanel6.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 0, 30, 50));
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        TuitionFees tuitionfeesvar = new TuitionFees();
        try {
            ...
            if (res == JOptionPane.YES_OPTION) {
                ...
                String selectedTuitionStr = (String) enrollmentcbb1.getSelectedItem();
                int selectedTuitionFees = Integer.parseInt(selectedTuitionStr);

                String selectedFees = (String) enrollmentcbb3.getSelectedItem();
                
                tuitionfeesvar.setTuitionID(selectedTuitionFees);
                tuitionfeesvar.setFeeName(selectedFees);
                
                tfc.addTuitionFees(tuitionfeesvar);
